...
describe('CSVCTCAdverseEventExtractor', () => {
  describe('formatData', () => {
    ...
    test('should join data appropriately and throw errors when missing required properties', () => {
      const expectedErrorString = 'The adverse event is missing an expected attribute. Adverse event code, adverse event text, effective date, and grade are all required.';
